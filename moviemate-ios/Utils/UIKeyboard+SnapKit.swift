...
extension UIView {
    ...
    @objc
    dynamic private func keyboardWillShow(notification: Notification) {
        ...
        UIView.animate(
            ...
            delay: 0,
            options: UIView.AnimationOptions(rawValue: option.uintValue),
            animations: {
                self.layoutIfNeeded()
            },
            completion: nil
    ...
    @objc
    dynamic private func keyboardWillHide(notification: Notification) {
        let duration = (notification as NSNotification).userInfo![UIResponder.keyboardAnimationDurationUserInfoKey] as! TimeInterval
        let option = (notification as NSNotification).userInfo![UIResponder.keyboardAnimationCurveUserInfoKey] as! NSNumber
